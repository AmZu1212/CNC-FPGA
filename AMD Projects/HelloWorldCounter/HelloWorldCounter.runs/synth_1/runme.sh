...
HD_PWD='C:/Users/AmZu/Desktop/Github_Renovations/CNC-FPGA/AMD Projects/HelloWorldCounter/HelloWorldCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_counter.tcl
