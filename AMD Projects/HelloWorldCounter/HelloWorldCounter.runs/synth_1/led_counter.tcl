...
synth_design -top led_counter -part xc7z020clg484-1
...
write_checkpoint -force -noxdef led_counter.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file led_counter_utilization_synth.rpt -pb led_counter_utilization_synth.pb"  } 
