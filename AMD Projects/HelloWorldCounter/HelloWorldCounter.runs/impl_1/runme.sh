...
HD_PWD='C:/Users/AmZu/Desktop/Github_Renovations/CNC-FPGA/AMD Projects/HelloWorldCounter/HelloWorldCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_counter.tcl -notrace
