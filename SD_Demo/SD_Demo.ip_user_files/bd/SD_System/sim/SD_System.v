...
(* CORE_GENERATION_INFO = "SD_System,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=SD_System,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=7,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "SD_System.hwdef" *) 
module SD_System
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  SD_System_Interconnect_Manager_0_0 Interconnect_Manager_0
       (.CMD(COMMAND_GPIO_gpio_io_o),
        ...
        .X(XY_GPIO_gpio_io_o),
        .Y(XY_GPIO_gpio2_io_o),
        .Z(Z_GPIO_gpio_io_o),
        .led(leds),
        .switch0(1'b0));
  SD_System_axi_gpio_0_0 XY_GPIO
       (.gpio2_io_o(XY_GPIO_gpio2_io_o),
