...
HD_PWD='E:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SD_System_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SD_System_wrapper.tcl -notrace
