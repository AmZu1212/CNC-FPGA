...
HD_PWD='X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/SD_System_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SD_System_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SD_System_axi_gpio_0_1.tcl
