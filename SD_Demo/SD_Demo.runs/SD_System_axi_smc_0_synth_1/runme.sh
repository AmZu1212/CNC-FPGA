...
HD_PWD='X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/SD_System_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SD_System_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SD_System_axi_smc_0.tcl
