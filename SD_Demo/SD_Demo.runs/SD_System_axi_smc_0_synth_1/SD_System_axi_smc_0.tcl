...
namespace eval ::optrace {
  variable script "X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/SD_System_axi_smc_0_synth_1/SD_System_axi_smc_0.tcl"
...
OPTRACE "SD_System_axi_smc_0_synth_1" START { ROLLUP_AUTO }
...
read_ip -quiet X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.srcs/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0.xci
...
set cacheID [config_ip_cache -export -no_bom  -dir X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/SD_System_axi_smc_0_synth_1 -new_name SD_System_axi_smc_0 -ip [get_ips SD_System_axi_smc_0]]
...
synth_design -top SD_System_axi_smc_0 -part xc7z020clg484-1 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix SD_System_axi_smc_0_ SD_System_axi_smc_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ SD_System_axi_smc_0_stub.v
 lappend ipCachedFiles SD_System_axi_smc_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ SD_System_axi_smc_0_stub.vhdl
 lappend ipCachedFiles SD_System_axi_smc_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ SD_System_axi_smc_0_sim_netlist.v
 lappend ipCachedFiles SD_System_axi_smc_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ SD_System_axi_smc_0_sim_netlist.vhdl
 lappend ipCachedFiles SD_System_axi_smc_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp SD_System_axi_smc_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips SD_System_axi_smc_0]
 }
...
rename_ref -prefix_all SD_System_axi_smc_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef SD_System_axi_smc_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file SD_System_axi_smc_0_utilization_synth.rpt -pb SD_System_axi_smc_0_utilization_synth.pb"  } 
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/SD_System_axi_smc_0_synth_1/SD_System_axi_smc_0.dcp x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/SD_System_axi_smc_0_synth_1/SD_System_axi_smc_0_stub.v x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/SD_System_axi_smc_0_synth_1/SD_System_axi_smc_0_stub.vhdl x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/SD_System_axi_smc_0_synth_1/SD_System_axi_smc_0_sim_netlist.v x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/SD_System_axi_smc_0_synth_1/SD_System_axi_smc_0_sim_netlist.vhdl x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.ip_user_files/ip/SD_System_axi_smc_0]} {
  catch { 
    file copy -force x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0_stub.v X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.ip_user_files/ip/SD_System_axi_smc_0
  }
}

if {[file isdir X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.ip_user_files/ip/SD_System_axi_smc_0]} {
  catch { 
    file copy -force x:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.gen/sources_1/bd/SD_System/ip/SD_System_axi_smc_0/SD_System_axi_smc_0_stub.vhdl X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.ip_user_files/ip/SD_System_axi_smc_0
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "SD_System_axi_smc_0_synth_1" END { }
