...
HD_PWD='X:/Git-Repos/CNC-FPGA/SD_Demo/SD_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SD_System_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SD_System_wrapper.tcl
