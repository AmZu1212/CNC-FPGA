...
HD_PWD='E:/Github Repositories/CNC-FPGA/Zedboard-CNC/Zedboard-CNC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CNC_Top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CNC_Top_wrapper.tcl
