...
#
# Script generated by Vivado on Wed Mar 04 17:17:25 +0200 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 24  -L xil_defaultlib -L xlconstant_v1_1_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CNC_Top xil_defaultlib.CNC_Top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CNC_Top -key {Behavioral:sim_1:Functional:CNC_Top} -tclbatch cmd.tcl -protoinst "protoinst_files/CNC_Top.protoinst" -log simulate.log
}
