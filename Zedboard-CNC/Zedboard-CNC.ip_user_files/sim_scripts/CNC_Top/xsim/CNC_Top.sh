...
#
# Script generated by Vivado on Mon Mar 30 23:45:10 +0300 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_9 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_3 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CNC_Top xil_defaultlib.CNC_Top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CNC_Top -key {Behavioral:sim_1:Functional:CNC_Top} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0a6d.protoinst" -protoinst "protoinst_files/CNC_Top.protoinst" -log simulate.log
}
