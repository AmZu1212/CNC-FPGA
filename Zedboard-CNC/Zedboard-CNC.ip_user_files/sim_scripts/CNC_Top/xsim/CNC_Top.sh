...
#
# Script generated by Vivado on Thu Mar 05 20:02:30 +0200 2026
...
#
# Usage        : CNC_Top.sh
#                CNC_Top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CNC_Top.sh [-reset_run]
#                CNC_Top.sh [-reset_log]
#                CNC_Top.sh [-help]
#
...
export RDI_DATADIR="E:/Programs/Xilinx/Vivado/2024.2/data"
...
# script info
echo -e "CNC_Top.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CNC_Top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_9 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CNC_Top xil_defaultlib.CNC_Top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CNC_Top -key {Behavioral:sim_1:Functional:CNC_Top} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_77fb.protoinst" -protoinst "protoinst_files/CNC_Top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CNC_Top.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./CNC_Top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: CNC_Top.sh [-help]\n\
Usage: CNC_Top.sh [-step]\n\
Usage: CNC_Top.sh [-lib_map_path]\n\
Usage: CNC_Top.sh [-reset_run]\n\
Usage: CNC_Top.sh [-reset_log]\n\
Usage: CNC_Top.sh [-keep_index]\n\
Usage: CNC_Top.sh [-noclean_files]\n\n\
