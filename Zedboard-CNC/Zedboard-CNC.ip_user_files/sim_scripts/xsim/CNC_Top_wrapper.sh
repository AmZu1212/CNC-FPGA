...
#
# Script generated by Vivado on Thu Mar 19 17:04:13 +0200 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : CNC_Top_wrapper.sh
...
#
# Usage        : CNC_Top_wrapper.sh
#                CNC_Top_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CNC_Top_wrapper.sh [-reset_run]
#                CNC_Top_wrapper.sh [-reset_log]
#                CNC_Top_wrapper.sh [-help]
#
...
# script info
echo -e "CNC_Top_wrapper.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CNC_Top_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L xpm -L xlconstant_v1_1_9 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_3 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot CNC_Top_wrapper xil_defaultlib.CNC_Top_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CNC_Top_wrapper -key {Behavioral:sim_1:Functional:CNC_Top_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0a6d.protoinst" -protoinst "protoinst_files/CNC_Top.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm xlconstant_v1_1_9 axi_infrastructure_v1_1_0 axi_vip_v1_1_19 processing_system7_vip_v1_0_21 axi_lite_ipif_v3_0_4 lib_cdc_v1_0_3 interrupt_control_v3_1_5 axi_gpio_v2_0_35 proc_sys_reset_v5_0_16 smartconnect_v1_0 axi_register_slice_v2_1_33)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CNC_Top_wrapper.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./CNC_Top_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: CNC_Top_wrapper.sh [-help]\n\
Usage: CNC_Top_wrapper.sh [-step]\n\
Usage: CNC_Top_wrapper.sh [-lib_map_path]\n\
Usage: CNC_Top_wrapper.sh [-reset_run]\n\
Usage: CNC_Top_wrapper.sh [-reset_log]\n\
Usage: CNC_Top_wrapper.sh [-keep_index]\n\
Usage: CNC_Top_wrapper.sh [-noclean_files]\n\n\
