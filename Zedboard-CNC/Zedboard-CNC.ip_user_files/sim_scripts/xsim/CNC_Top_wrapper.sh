...
#
# Script generated by Vivado on Sat Nov 29 20:52:09 +0200 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L xlconstant_v1_1_9 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot CNC_Top_wrapper xil_defaultlib.CNC_Top_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CNC_Top_wrapper -key {Behavioral:sim_1:Functional:CNC_Top_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/CNC_Top.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Programs/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xpm xlconstant_v1_1_9)
