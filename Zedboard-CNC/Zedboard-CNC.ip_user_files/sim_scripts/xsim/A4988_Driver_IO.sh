...
#
# Script generated by Vivado on Wed Jun 18 01:43:13 +0300 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : A4988_Driver_IO.sh
...
#
# Usage        : A4988_Driver_IO.sh
#                A4988_Driver_IO.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                A4988_Driver_IO.sh [-reset_run]
#                A4988_Driver_IO.sh [-reset_log]
#                A4988_Driver_IO.sh [-help]
#
...
# script info
echo -e "A4988_Driver_IO.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./A4988_Driver_IO.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot A4988_Driver_IO xil_defaultlib.A4988_Driver_IO xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim A4988_Driver_IO -key {Behavioral:sim_1:Functional:A4988_Driver_IO} -tclbatch cmd.tcl -protoinst "protoinst_files/CNC_Top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb A4988_Driver_IO.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./A4988_Driver_IO.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: A4988_Driver_IO.sh [-help]\n\
Usage: A4988_Driver_IO.sh [-step]\n\
Usage: A4988_Driver_IO.sh [-lib_map_path]\n\
Usage: A4988_Driver_IO.sh [-reset_run]\n\
Usage: A4988_Driver_IO.sh [-reset_log]\n\
Usage: A4988_Driver_IO.sh [-keep_index]\n\
Usage: A4988_Driver_IO.sh [-noclean_files]\n\n\
