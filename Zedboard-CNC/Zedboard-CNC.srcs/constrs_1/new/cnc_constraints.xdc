...
# Pull Up & Downs
set_property PULLDOWN true [get_ports drv_direction]
set_property PULLDOWN true [get_ports drv_step]
set_property PULLUP   true [get_ports drv_reset]
set_property PULLDOWN true [get_ports drv_enable]
...
set_property PULLDOWN true [get_ports {left}]
set_property PULLDOWN true [get_ports {right}]
