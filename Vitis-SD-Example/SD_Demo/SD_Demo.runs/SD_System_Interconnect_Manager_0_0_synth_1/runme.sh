...
EAStep vivado -log SD_System_Interconnect_Manager_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SD_System_Interconnect_Manager_0_0.tcl
