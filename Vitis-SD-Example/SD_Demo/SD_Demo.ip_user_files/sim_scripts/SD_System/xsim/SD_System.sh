...
#
# Script generated by Vivado on Thu Mar 05 13:23:37 +0200 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : SD_System.sh
...
#
# Usage        : SD_System.sh
#                SD_System.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SD_System.sh [-reset_run]
#                SD_System.sh [-reset_log]
#                SD_System.sh [-help]
#
...
# script info
echo -e "SD_System.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SD_System.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SD_System.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SD_System.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SD_System.sh [-help]\n\
Usage: SD_System.sh [-step]\n\
Usage: SD_System.sh [-lib_map_path]\n\
Usage: SD_System.sh [-reset_run]\n\
Usage: SD_System.sh [-reset_log]\n\
Usage: SD_System.sh [-keep_index]\n\
Usage: SD_System.sh [-noclean_files]\n\n\
