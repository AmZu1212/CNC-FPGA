...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = ACK_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = LAST_LINE_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = MOUNT_FAIL_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = MOUNT_OK_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = MOUNT_REQ_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = REQ_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = SPEED_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = X_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = Y_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = Z_GPIO
END
